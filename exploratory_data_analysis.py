...
def generate_and_save_plots(dataframe):
    ...
    plt.ylabel('RMSE')
    plt.savefig('code/plots/rmse_boxplot.png')
    ...
    plt.legend()
    plt.savefig('code/plots/rmse_linechart.png')
    ...
    plt.xlabel('Pairing Type')
    plt.ylabel('SPARC')
    plt.savefig('code/plots/sparc_boxplot.png')
    plt.close()  # Close the plot
    ...
    plt.legend()
    plt.savefig('code/plots/sparc_linechart.png')
    plt.close()  # Close the plot
